// PET -> will have an owner, that is a user
...
// virtuals go here
// additional properties that are processed between the request and the response
...
petSchema.virtual('fullTitle').get(function () {
    // in here, we can do whatever javascript-y things we want to make sure we return some value that will be assigned to this virtual
