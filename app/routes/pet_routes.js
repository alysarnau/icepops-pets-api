...
// INDEX
// GET /pets
// because we want anyone to view pets - we removed the 'requireToken' middleware
router.get('/pets', (req, res, next) => {
	// if we wanted to protect these resources, then we could add that middleware back in.
	// and we would place that between the route and callback function (second arg)
	Pet.find()
		.then((pets) => {
...
// same as above, not protecting it (not needed)
